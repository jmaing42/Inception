...
wp-cli.phar core install --url=${INTRA_LOGIN}.42.fr --title="${WORDPRESS_TITLE}" --admin_name="${WORDPRESS_USER}" --admin_password="${WORDPRESS_PASSWORD}" --admin_email=${WORDPRESS_EMAIL} --path=/app/wordpress
